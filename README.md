...
![SDK CI Workflow](https://github.com/USER/vehicle-app-cpp-sdk/actions/workflows/ci.yml/badge.svg)
...
## Contribution
- [GitHub Issues](https://github.com/USER/vehicle-app-cpp-sdk/issues)
